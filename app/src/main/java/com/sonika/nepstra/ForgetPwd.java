...
////
 private WebView myWebView;
    ...
    public static final String PREF_STRING = "https://nepstra.com/shop/my-account/lost-password/";
   ...
   protected void onCreate(Bundle savedInstanceState) {
        ...
        myWebView.loadUrl(mPrefs.getString(PREF_STRING, "https://nepstra.com/shop/my-account/lost-password/"));
      ...
      //  myWebView.setWebViewClient(new WebViewClient());
       ...
       myWebView.loadUrl("https://nepstra.com/shop/my-account/lost-password/");
